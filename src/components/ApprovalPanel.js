...
//   <table className="admin-table" style={{ minWidth: "900px", width: "100%", borderCollapse: "collapse" }}>
//     <thead>
//       <tr>
//         <th>Event Name</th>
//         <th>Event Title</th>
...
function HeadApprovalPanel() {
  ...
  return (
    <div className="approval-page">
      ...
      {/* ✅ Main Panel - removed any left padding/gap */}
      <div className="approval-content" style={{ marginLeft: 0, paddingLeft: 0 }}>
        {/* Dashboard Section - EXACT SAME SIZE AS USERDASHBOARD */}
        {activeTab === "dashboard" && (
          <div className="user-dashboard-container">
            <div className="dashboard-header">
        ...
        {/* Pending Events - Fixed table layout with no gap */}
        {activeTab === "pending" && (
          <div className="events-section" style={{ marginLeft: 0, paddingLeft: 0, width: "100%" }}>
            <h3>Pending Approval</h3>
            {pendingEvents.length === 0 ? (
              <p>No pending events.</p>
            ) : (
              <div style={{ width: "100%", overflowX: "auto", overflowY: "visible" }}>
                <table className="admin-table" style={{ minWidth: "900px", width: "100%", borderCollapse: "collapse", margin: 0 }}>
                  <thead>
                    <tr>
                      <th>Event Name</th>
                      <th>Event Title</th>
